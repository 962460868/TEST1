...
def main():
    ...
    <div style='text-align: center; color: #6c757d; padding: 15px;'>
        <b>🚀 RunningHub AI - 三功能整合版 v2.3</b><br>
        <small>溶图打光 (新增) + 姿态迁移 (延迟清空) + 图像优化 (预览模式)</small>
    </div>
    """, unsafe_allow_html=True)
